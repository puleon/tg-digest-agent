...
| D16 · Digest pairwise | 8 weekly pairs on the owner's profile, judged in both orders by Qwen3.6 and gpt-oss-120b: v1 **5 : 1** under both, judges agree (κ 1.0 on 5 pairs), position flips 0.25 — and the longer issue won every consistent verdict, because a global "top by views" baseline starved the cinema slots (3–6 items vs 8). Recorded as verbosity bias; ⏳ round 2 on a per-topic views baseline. | [d16-digest](docs/experiments/d16-digest/README.md) |
